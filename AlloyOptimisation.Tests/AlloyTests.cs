...
public class AlloyTests
{
    ...
    {
        var alloy = new Alloy(_config);
        var ex = Assert.Throws<AlloyException>(() => alloy.UpdateComponent("He", 5));
    ...
    {
        var alloy = new Alloy(_config);
        var ex = Assert.Throws<AlloyException>(() => alloy.UpdateComponent("Cr", 13));
    ...
    {
        var alloy = new Alloy(_config);
        var ex = Assert.Throws<AlloyException>(() => alloy.UpdateComponent("Cr", 25));
    ...
    {
        var alloy = new Alloy(_config);
        var ex = Assert.Throws<AlloyException>(() => alloy.UpdateComponent("Ni", 25));
    ...
    {
        var alloy = new Alloy(_config);
        alloy.UpdateComponent("Co", 20);
        Assert.Equal(2, alloy.GetComposition().Count);
        alloy.UpdateComponent("Co", 0);
        Assert.Single(alloy.GetComposition());
        Assert.Equal("Ni", alloy.GetComposition()[0].Element);
        Assert.Equal(100, alloy.GetComposition()[0].AtomicPercentage);
    }
    ...
    public void CanCalculateCreepResistance()
    {
        ...
        var alloy = new Alloy(_config);
        alloy.UpdateComponent("Cr", 15);
        alloy.UpdateComponent("Co", 10);
        alloy.UpdateComponent("Nb", 1);
        alloy.UpdateComponent("Mo", 2);
        Assert.Equal(1226074882000000000, alloy.GetCreepResistance());

        alloy.UpdateComponent("Cr", 20);
        alloy.UpdateComponent("Co", 0);
        alloy.UpdateComponent("Nb", 0);
        alloy.UpdateComponent("Mo", 1.5m);
        Assert.Equal(551913820500000000, alloy.GetCreepResistance());

        alloy.UpdateComponent("Cr", 22);
        alloy.UpdateComponent("Co", 25);
        alloy.UpdateComponent("Nb", 1.5m);
        alloy.UpdateComponent("Mo", 6);
